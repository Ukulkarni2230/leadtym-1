...
const data = {
  monthly: [
    ...
    { hour: "08am", AverageSessionDuration: 110, PagesPerSession: 100 },
    { hour: "09am", AverageSessionDuration: 170, PagesPerSession: 150 },
    { hour: "10am", AverageSessionDuration: 150, PagesPerSession: 120 },
  ],
};
  ...
  return (
      <ResponsiveContainer width="100%" height={300}>
        <BarChart data={data.monthly} margin={{ top: 0, right: 4, left: 0, bottom: 4 }}>
          ...
          <Legend />
          <Bar dataKey="AverageSessionDuration" fill="#7661F5" name="Average Session Duration" />
          {/* <Bar dataKey="PagesPerSession" fill="#9BDFC4" name="Pages per Session" /> */}
        </BarChart>
      </ResponsiveContainer>
  );
};

export default Engagementmatriceschart;
