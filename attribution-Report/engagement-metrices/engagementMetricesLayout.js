...
import Engagementmatriceschart from './Engagematriceschart';

const EngagementMetricesLayout = () => {
    const stats = [
  ...
  return (
    ...
    <p className='text-[#222529] text-base sm:text-lg 2xl:text-xl font-bold' >Engagement Rate per Post</p>
...
export default EngagementMetricesLayout